module.exports = function (ctx) {
    ...
    return {
        ...
        parser: 'postcss-scss',
        plugins: [
            require('@csstools/postcss-sass')({style: 'expanded', alertAscii: true, alertColor: true, verbose: ctx.env !== 'production'}),
            require('postcss-import')({root: root}),
            require('postcss-strip-inline-comments'),
            require('postcss-will-change'),
            require('postcss-color-rebeccapurple')({ preserve: false }),
