...
export default class BaseCalculation {
   ...
   * @var float
   */
  private rvsatzan: number = 0.0000;
   ...
   * @var float
   */
  private kvsatzan: number = 0.00000;
